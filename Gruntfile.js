        ...
        concat: {
            dist: {
                src: [
                    ...
                    '<%= config.app %>/scripts/smb_client/auth/crc32.js',
                    ...
                    '<%= config.app %>/scripts/smb_client/auth/ntlm2_session_response.js',
                    ...
                    '<%= config.app %>/scripts/smb_client/auth/second_key.js',
                    '<%= config.app %>/scripts/smb_client/auth/subkey.js',
                    '<%= config.app %>/scripts/smb_client/auth/signature.js',
                    ...
                    '<%= config.app %>/scripts/smb_client/smb2/models/negotiate_request.js',
