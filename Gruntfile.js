        ...
        concat: {
            dist: {
                src: [
                    ...
                    '<%= config.app %>/scripts/smb_client/models/header.js',
                    '<%= config.app %>/scripts/smb_client/models/packet.js',
                    '<%= config.app %>/scripts/smb_client/models/file.js',
                    '<%= config.app %>/scripts/smb_client/models/request_utils.js',
                    '<%= config.app %>/scripts/smb_client/models/response_utils.js',
                    '<%= config.app %>/scripts/smb_client/models/negotiate_protocol_request.js',
                    '<%= config.app %>/scripts/smb_client/models/negotiate_protocol_response.js',
                    '<%= config.app %>/scripts/smb_client/models/session_setup_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/models/session_setup_andx_response.js',
                    '<%= config.app %>/scripts/smb_client/models/echo_request.js',
                    '<%= config.app %>/scripts/smb_client/models/tree_connect_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/models/tree_connect_andx_response.js',
                    '<%= config.app %>/scripts/smb_client/models/nt_create_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/models/nt_create_andx_response.js',
                    '<%= config.app %>/scripts/smb_client/models/dce_rpc.js',
                    '<%= config.app %>/scripts/smb_client/models/dcerpc_bind.js',
                    '<%= config.app %>/scripts/smb_client/models/dcerpc_bind_ack.js',
                    '<%= config.app %>/scripts/smb_client/models/dcerpc_net_share_enum_all_request.js',
                    '<%= config.app %>/scripts/smb_client/models/dcerpc_net_share_enum_all_response.js',
                    '<%= config.app %>/scripts/smb_client/models/transaction_request.js',
                    '<%= config.app %>/scripts/smb_client/models/transaction_response.js',
                    '<%= config.app %>/scripts/smb_client/models/close_request.js',
                    '<%= config.app %>/scripts/smb_client/models/query_path_info_request.js',
                    '<%= config.app %>/scripts/smb_client/models/query_path_info_response.js',
                    '<%= config.app %>/scripts/smb_client/models/find_first2_request.js',
                    '<%= config.app %>/scripts/smb_client/models/find_first2_response.js',
                    '<%= config.app %>/scripts/smb_client/models/find_next2_request.js',
                    '<%= config.app %>/scripts/smb_client/models/find_next2_response.js',
                    '<%= config.app %>/scripts/smb_client/models/find_close2_request.js',
                    '<%= config.app %>/scripts/smb_client/models/seek_request.js',
                    '<%= config.app %>/scripts/smb_client/models/seek_response.js',
                    '<%= config.app %>/scripts/smb_client/models/read_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/models/read_andx_response.js',
                    '<%= config.app %>/scripts/smb_client/models/write_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/models/write_andx_response.js',
                    '<%= config.app %>/scripts/smb_client/models/create_directory_request.js',
                    '<%= config.app %>/scripts/smb_client/models/delete_request.js',
                    '<%= config.app %>/scripts/smb_client/models/delete_directory_request.js',
                    '<%= config.app %>/scripts/smb_client/models/rename_request.js',
                    '<%= config.app %>/scripts/smb_client/models/empty_request.js',
                    '<%= config.app %>/scripts/smb_client/models/logoff_andx_request.js',
                    '<%= config.app %>/scripts/smb_client/protocol.js',
